          ...
          <View style={styles.card}>
              <Image
                ...
                <TouchableOpacity onPress={() => setVerMais(!verMais)}>
                    <Text style={styles.button}>{verMais ? 'Ver Menos' : 'Ver Mais' }</Text>
                </TouchableOpacity>
                {verMais && (<View style={styles.detalhes}>
                    <Text>Localização: João Pessoa</Text>
                    <Text>E-mail: knjsato1@gmail.com</Text>
                    <Text>Hobbies: Programar, viajar e jogar</Text>
...
const styles = StyleSheet.create({
  ...
  main: { flex: 7, backgroundColor: 'white', justifyContent: 'center', alignItems: 'center'},
  ...
  detalhes: {marginTop: 10, alignItems: 'center'}
});
